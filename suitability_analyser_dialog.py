...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'suitability_analyser_dialog_base.ui'))


class SuitabilityAnalyserDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(SuitabilityAnalyserDialog, self).__init__(parent)
